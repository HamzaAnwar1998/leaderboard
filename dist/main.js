...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_handleAPI_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/handleAPI.js */ \"./src/modules/handleAPI.js\");\n\n\n\n// getting elements\nconst ul = document.getElementById('ul');\nconst form = document.querySelector('.form');\nconst username = document.getElementById('username');\nconst userscore = document.getElementById('userscore');\n\n// getting data from api\ndocument.getElementById('refresh').addEventListener('click', async () => {\n  const data = await _modules_handleAPI_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].listScores();\n  data.result.forEach((individualData) => {\n    ul.innerHTML += `<li class=\"score\">\n    <span>${individualData.user}:${individualData.score}</span>\n    </li>`;\n  });\n});\n\n// sending data\nform.addEventListener('submit', async (e) => {\n  e.preventDefault();\n  await _modules_handleAPI_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].sendData(username.value, userscore.value);\n});\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
